...
<head>
    <meta charset="utf-8">
    <title>Treddur | Get Tyres at Best Price</title>

    <meta name="author" content="k3.studio">
                                        ...
                                        <div class="logo">
                                            <a href="index.php">
                                                <img class="lazyload img-none" data-src="assets/images/logo/logo2.png"
                                                    src="assets/images/logo/logo2.png" alt="" width="225" height="40">
                                                <img class="lazyload img-is-fixed"
                                                    data-src="assets/images/logo/logo@2x.png"
                                                    src="assets/images/logo/logo%402x.png" alt="" width="225"
                                                    height="40">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="nav-outer flex align-center">
                                        ...
                                        <nav class="main-menu show navbar-expand-md">
                                            <div class="navbar-collapse collapse clearfix" id="navbarSupportedContent">
                                                ...
                                                <li><a href="deals-offers.php">Deals & Offers</a></li>
...
if ($current_page !== 'index.php') { ?>
                                <a class="sc-button" href="index.php">
                                    <?php } else { ?>
                        ...
                        <div class="nav-logo">
                            <a href="index.php">
                                <img class="lazyload" data-src="assets/images/logo/logo@2x.png"
                                    src="assets/images/logo/logo%402x.png" alt="" width="197" height="48"></a>
                        </div>
...
if ($current_page !== 'index.php') { ?>
                                <a class="sc-button btn-icon center" href="index.php">
                                    <?php } else { ?>
                                <a class="sc-button btn-icon center" href="#">
                                    <?php } ?>
                                    <svg width="21" height="20" viewBox="0 0 21 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_4960_5223)">
