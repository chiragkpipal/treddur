...
<section class="tf-banner style-1 mt-10" style="background: url('https://www.tirerack.com/content/dam/tirerack/desktop/components/hero/s23_Home.jpg')">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="content relative z-2">
                                <div class="heading">
                                    <h1 class="text-color-1">Buying tires <br> has never been easier!</h1>
                                    <p class="text-color-1 fs-18 fw-4 lh-22 font">Leading online tire comparison
                                        platform. helps users buy <br>
                                        tires that are right for them</p>
                                    <a href="#" class="sc-button btn-svg">
                                        <span>Search for your favorite tire</span>
                        ...
                        <div class="col-md-6">
                            <div class="image-wcs relative">
                                <ul class="icon-list">
                                    ...
                                    <li class="tf-icon-list ani5">
                                        <i class="icon-autodeal-check"></i>
                                        <span class="fs-18 fw-6 lh-25 text-color-2">7,800 tire sellers</span>
                                    </li>
                                </ul>
                                <div class="image-inner1 hover-img-wrap img-style-hover">
                                    <img class=" ls-is-cached lazyloaded" data-src="assets/images/section/wcu-1.jpg"
                                        src="assets/images/section/wcu-1.jpg" alt="images">
                                </div>
                                <div class="image-inner2">
                                    <img class=" ls-is-cached lazyloaded" data-src="assets/images/section/wcu-2.png"
                                        src="assets/images/section/wcu-2.png" alt="images">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="content-wcs">
                                <div class="heading-section">
                                    <h2>Why Choose Treddur</h2>
                                    <p class="mt-18">Our experienced team excels in tire sales with many years of
                                ...
                                <div class="tf-icon-box-list">
                                    <div class="tf-icon-box style-2">
                                        ...
                                        <div class="content">
                                            ...
                                            <p>Our experienced team excels in tire sales with many years of successfully
                                    ...
                                    <div class="tf-icon-box style-2">
                                        ...
                                        <div class="content">
                                            ...
                                            <p>We pride ourselves on creating personalized strategies to suit your
                                                unique goals, ensuring a seamless tire selling journey.</p>
                                        </div>
                                    </div>
                                    <div class="tf-icon-box style-2">
                                        <div class="icon">
